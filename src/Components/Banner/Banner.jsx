    ...
    return (
        <div className='md:w-10/12 mx-10 md:mx-auto grid md:flex items-center justify-between gap-5 text-white opacity-100' id='banner'>
            <div className='md:my-40 mt-32 mb-10 w-full space-y-3'  data-aos="fade-right" data-aos-duration="2000"> 
                ...
                <div className='my-5' data-aos="fade-up" data-aos-duration="3000">
                    <button onClick={handleDownload} className='bg-purple-600 font-bold rounded px-2 md:px-3 py-1 flex items-center gap-1 md:gap-2 cursor-pointer hover:bg-transparent border-2 border-purple-600 hover:shadow-md hover:shadow-purple-500' style={{ transition: '0.3s' }}>Download Resume <FaDownload /> </button>
                </div>
