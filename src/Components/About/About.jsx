    ...
    return (
        <div className='w-10/12 mx-auto grid md:flex gap-5 md:gap-16 justify-center items-center  pt-8' id='about'>
            ...
            <div className=''>
                ...
                <div className='mt-3'>
                <Link to='contact' spy={true} smooth={true} offset={-50} duration={1000} className='bg-purple-600 font-bold rounded px-3 py-1 cursor-pointer hover:bg-transparent border-2 border-purple-500 hover:text-purple-500' style={{transition: '0.3s'}}>Get In Touch</Link>
                </div>
            </div>
