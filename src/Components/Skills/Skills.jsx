    ...
    return (
        <div >
            <div className='my-10 mx-10 md:w-10/12 md:mx-auto pt-8' id='skill'>
                <h1 className='text-center text-purple-500 text-4xl font-semibold pb-2'>My Skill's</h1>
                ...
                <div className='grid grid-cols-4 md:grid-cols-8 gap-5 my-8 justify-center justify-items-center items-center'>
                    <div className='shadow-md shadow-purple-300 p-2 bg-slate-950 rounded text-center space-y-2' >
